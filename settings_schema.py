...
SETTINGS_SCHEMA = {
    ...
    "miniapp_hub_referral_invites_text": {
        ...
        "default": "{count} приглашённых по твоей ссылке",
    },
    ...
    "miniapp_form_ambassador_link_note_text": {
        ...
        "default": (
            "Эту ссылку всегда можно найти в чате с ботом — кнопка «🔗 Моя реферальная "
            "ссылка» — или в приложении, раздел «{section}», после одобрения заявки."
        ),
        "per_city": True,
    },
