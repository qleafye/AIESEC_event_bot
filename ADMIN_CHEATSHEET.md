...
| Выбрать, какие разделы видны в приложении | 🔧 Управление → 🎨 Оформление → чекбоксы разделов (Задания, Монеты, Рейтинг, Профиль, Анкета — делегату; Проверка сдач, 🗂 Задания (менеджер), 🗂 Отбор заявок, Статистика, Настройки-лайт — менеджеру) |
