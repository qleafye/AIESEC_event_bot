...
| Выбрать, какие разделы видны в приложении | 🔧 Управление → 🎨 Оформление → чекбоксы разделов (Задания, Монеты, Рейтинг, Профиль, Анкета — делегату; Проверка сдач, 🗂 Задания (менеджер), Статистика, Настройки-лайт — менеджеру) |
...
| Настроить, какие ответы видны в карточке заявки | `/admin` → **📋 Заявки** → «🧾 Поля карточки заявки» — чекбокс на каждый вопрос + лимит длины ответа |
