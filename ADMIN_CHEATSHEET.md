...
| Настроить, какие ответы видны в карточке заявки | `/admin` → **📋 Заявки** → «🧾 Поля карточки заявки» — чекбокс на каждый вопрос + лимит длины ответа; один набор и на карточку в чате, и на карточку в приложении |
