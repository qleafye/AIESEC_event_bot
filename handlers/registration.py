...
# Phase 13 REFAC (13-03, REFAC-02): seam import triggers decoration of the per-state
# process_* step handlers (reg_steps.py) on THIS module's shared `router` object. Positioned
# at the very bottom since this block was the LAST handler group in the original file --
# import order here IS handler registration order (T-13-04).
