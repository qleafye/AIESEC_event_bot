    ...
    (
        ...
        [
            ...
            },
            {
                ...
                "values": _GUIDE_ONOFF,
                "default": "on",
                "where": "⚙️ Настройки → кнопка «📋 Сводка о заявках»",
            },
            {
        ...
        [
            {
                ...
                "values": _GUIDE_ONOFF,
                "default": "on",
                "where": "⚙️ Настройки → кнопка «⏰ Догонялка анкет»",
            },
            {
                ...
                "default": "120 (2 часа)",
                "unit": " мин.",
                "where": "⚙️ Настройки → «📝 Регистрация» → «⏰ Догонялка: через сколько минут»",
            },
            {
                "key": "nudge_text",
                ...
                "where": "⚙️ Настройки → «📝 Регистрация» → «⏰ Догонялка: текст напоминания»",
            },
        ],
    ),
    (
        ...
        [
            ...
            },
            {
                ...
                "where": "⚙️ Настройки → «📝 Регистрация» → «🎯 Предотбор: не прошёл»",
            },
            {
                "key": "preselect_link",
                ...
                "default": "нет",
                "where": "⚙️ Настройки → «📝 Регистрация» → «🎯 Предотбор: ссылка»",
            },
        ],
    ),
    (
