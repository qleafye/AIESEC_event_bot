...
SETTINGS_GUIDE_SECTIONS = [
    ...
    (
        "🎮 Геймификация: амбассадорские волны",
        "Баллы за приглашённых, штраф за просрочку, призовые места, тексты волн.",
        [
            {"key": "ambassador_referral_coins", "label": "Баллы за приглашённого", "what": "За КАЖДУЮ одобренную заявку приглашённого амбассадору; 0 — выключено, назад не снимается.", "default": "0", "where": "🎮 Геймификация → «⚙️ Тексты и настройки» → «🤝 Баллы за приглашённого»"},
            ...
            {"key": "wave_prize_places", "label": "Призовых мест в волне", "what": "Сколько верхних строк рейтинга волны станут призовыми при объявлении итогов.", "default": "3", "where": "🎮 Геймификация → «⚙️ Тексты и настройки» → «🏅 Призовых мест в волне»"},
            {"key": "wave_rating_show_names", "label": "Имена в рейтинге волны", "what": "Выключено — амбассадор видит только своё место и отрыв от призового, без чужих имён.", "values": _GUIDE_ONOFF, "default": "on", "where": "🎮 Геймификация → «⚙️ Тексты и настройки» → тумблер «🏅 Показывать имена в рейтинге волны»"},
            {"key": "wave_start_message_text", "label": "Текст старта волны", "what": "ЛС каждому действующему амбассадору при старте волны: вводный текст + список заданий.", "default": "стандартный текст", "where": "🎮 Геймификация → «⚙️ Тексты и настройки» → «🌊 Старт волны: текст»"},
        ],
    ),
]
