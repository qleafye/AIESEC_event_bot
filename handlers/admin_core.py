...
_ADMIN_MENU_ROWS: list[tuple[str, str]] = [
    ...
    # Quick 260906-8uq (FAQ-01..06): раздел ведения FAQ, рядом с журналом вопросов (кнопка
    # «❓ В FAQ» задачи 4 кладёт пункт из журнала прямо сюда).
    ("❓ Частые вопросы", "admin_faq"),
