...
Право по городу (`can_edit_city`, D-16) перепроверяется в КАЖДОМ мутирующем и рендерящем шаге
конструктора (T-31-10-01) — клавиатуры в чате не истекают, а FSM-состояние может пережить правку.
