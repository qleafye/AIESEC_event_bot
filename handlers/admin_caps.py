...
ADMIN_CAPS: dict[str, str] = {
    ...
    # Hotfix (GAME-08): task archive/delete screen — registered in the SAME commit as the
    # handlers (09-01 convention). WARNING: "gtdelete:*" does NOT cover "gtdelete_go:*"
    # (prefix match is on "gtdelete:", the char right after "gtdelete" in "gtdelete_go" is
    # "_", not ":") — same precedent as roles_cap:*/roles_caps:*, both keys are required, not
    # just the shorter one. Same for "gtarchive:*" vs "gtarchive_go:*".
