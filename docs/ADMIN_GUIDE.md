...
- Двенадцать чекбоксов-разделов — какие экраны видны в приложении: 🎯 Задания, 🪙 Монеты,
  ...
  **🗂 Отбор заявок**, **❓ Вопросы делегатов**, 🗂 Задания (менеджер), 📊 Статистика,
  ...
  Выключение «❓ Частые вопросы» прячет плитку и список FAQ у делегата в приложении — сам
  раздел FAQ в чате бота (§7) продолжает работать как обычно, вести список менеджер по-прежнему
  может только в чате (в приложении есть только кнопка «В FAQ» под отвеченным вопросом, без
  полноценного экрана управления).
...
Заводить пункты FAQ из приложения менеджер пока не может напрямую — только кнопка «В FAQ» под
отвеченным вопросом на экране «❓ Вопросы делегатов» (см. выше, «📋 Заявки в приложении»):
открывает форму с предзаполненными вопросом и ответом, которые можно поправить перед
сохранением. Полноценный экран ведения FAQ (список, порядок, скрытие, удаление) в приложении
не заведён — эти действия по-прежнему только в чате бота.
