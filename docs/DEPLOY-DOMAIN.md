...
⚠️ Точная форма поля `Path` в этой панели (обычный текст regex или что-то иное) на момент
написания рунбука не проверена на живом стенде — открытый вопрос. При настройке на стенде
вписать сюда рабочий вариант, если панель потребует другой синтаксис, чем `^/app(/|$)`.
