...
Бот начинался в феврале 2026 как разовая утилита под форум **SkillUp4** (26 апреля).
...
В мае код переехал в этот репозиторий, и задача сменилась — не «бот под форум», а один бот
...
gantt
    ...
    section Разовый бот
    Хардкод анкеты, рассылка всем       :done, 2026-02-01, 2026-04-26
    Перенос в общий репозиторий         :done, 2026-05-07, 2026-06-08

    section v1.0 — к SumMeet
    ...
    Хвосты, настройки из .env в бота    :active, 2026-08-17, 2026-08-26
    Дашборд статистики, редизайн UI     :2026-08-26, 2026-09-20
```
