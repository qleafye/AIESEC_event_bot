...
**→ [ADMIN_GUIDE.md](docs/ADMIN_GUIDE.md) — полный гайд менеджера события.** Как провести
...
| Кому | Файл |
|------|------|
| Менеджеру события — полный гайд | **[ADMIN_GUIDE.md](docs/ADMIN_GUIDE.md)** |
| Менеджеру события — шпаргалка на одну страницу | [ADMIN_CHEATSHEET.md](docs/ADMIN_CHEATSHEET.md) |
| Тестировщику — чек-лист «что потыкать» | [BOT_GUIDE.md](docs/BOT_GUIDE.md) |
...
docs/ADMIN_GUIDE.md). `код` — латиница/цифры/`_`, до 16 символов, используется в deep-link
...
бэкфилла старых строк). Дальше всё — из админки, «🏙 Города» (см. docs/ADMIN_GUIDE.md, раздел
«Города мероприятия»).
