...
![Раздел «Событие»](docs/img/admin/01-section-event.png)
...
![Раздел «Анкета»](docs/img/admin/02-section-form.png)
...
📋 Заявки · 🔒 Залипшие вопросы · тумблеры модерации, уведомлений, предотбора, сводки и
догонялки · тексты после подачи («📋 Заявки»).

![Раздел «Заявки»](docs/img/admin/03-section-apps.png)

*Сверху сама очередь и залипшие вопросы, посередине тумблеры, в самом низу — группа
...
![Раздел «Оплата»](docs/img/admin/04-section-pay.png)
...
![Раздел «Общение»](docs/img/admin/05-section-comms.png)
...
![Раздел «Геймификация»](docs/img/admin/06-section-game.png)
...
дубли из таблицы · «📄 Вкладки таблицы» · «📊 Дашборд».

![Раздел «Данные»](docs/img/admin/07-section-data.png)
...
![Раздел «Управление»](docs/img/admin/08-section-manage.png)
...
![Старая кнопка «Настройки форума»](docs/img/admin/13-old-settings-button.png)
...
![Экран группы настроек «Заявки»](docs/img/admin/09-settings-group-apps.png)
...
![Промпт правки значения](docs/img/admin/10-edit-prompt.png)
...
YouLead’26, а не расписание на сегодня.
...
![Экран вернувшегося делегата](docs/img/admin/12-returning-delegate.png)
...
![Экран «Оформление»](docs/img/admin/11-miniapp-theme.png)
