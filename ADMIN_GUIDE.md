...
📋 Заявки · 🔒 Залипшие вопросы · 🧾 Поля карточки заявки · тумблеры модерации, уведомлений,
...
Та же анкета целиком доступна и в Mini App («📝 Анкета» в хабе делегата, §25) — прогресс
общий с чатом: начал в одном месте, продолжил в другом, ничего не переспрашивается заново.
...
- Девять чекбоксов-разделов — какие экраны видны в приложении: 🎯 Задания, 🪙 Монеты,
  🏆 Рейтинг, 👤 Профиль, **📝 Анкета**, 🎮 Проверка сдач, 🗂 Задания (менеджер),
  📊 Статистика, ⚙️ Настройки-лайт. Выключенный раздел просто не появляется в навигации
  приложения — у всех, кому он был бы виден. Выключение «📝 Анкета» прячет разом четыре
  вещи: плитку «📝 Анкета» в хабе, кнопку «📱 Заполнить в приложении» после приветствия
