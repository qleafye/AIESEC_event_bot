...
подсказки в заданиях геймификации, заголовок баланса, рейтинг, рефералка — лежит в
настройках, а не в коде. Ищите по группам «⚙️ Настройки»: 🎪 Событие/Медиа (приветствия,
заглушки, «задать вопрос»), 📝 Регистрация (после заявки / одобрения / отклонения, развилки),
💳 Оплата (тексты тарифов, реквизитов, «оплачу позже»), 🎮 Геймификация (экраны заданий,
сдачи, баланса). У каждого текста есть стандартный вариант — отправить `-` вернёт его.
...
включения нового пункта (например, «🎯 Задания») нужна рассылка с просьбой перезапустить бота.
...
чтобы посмотреть глазами, считает всё бот.
