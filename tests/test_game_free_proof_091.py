...
def test_game_settings_schema_has_nine_keys_in_game_group():
    ...
    # Phase 16 (16-02): +2 -- шаблон счётчика сдачи и кнопка «Убрать последнее».
    # Phase 16 (16-03): +3 -- превью «как видит делегат», заголовок и кнопка публикации визарда.
    # Phase 16 (16-04): +1 -- пресеты сумм ручных монет (coins_manual_amount_presets).
    # Quick 260822: +2 -- режим уведомлений о сдачах (тумблер) и окно тишины дайджеста.
    # Амбассадорский слой (291bdd2): +24 -- числовые ключи волны (баллы за приглашённого,
    # штраф за просрочку, призовые места), тумблер "Показывать имена в рейтинге волны" и
