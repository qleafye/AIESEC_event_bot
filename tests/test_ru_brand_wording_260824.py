...
Phase 27 (27-02, LANG-08): английские тексты делегатской анкеты живут в `translations`
(БД не сканируется этим файловым сторожем в принципе) и в корневых модулях
`i18n_ui_en.py` / `services/i18n_glossary.py` — это ИСТОЧНИК английского для делегата,
а не текст ДЛЯ РУССКОГО, которого касается правило владельца. Расширять скан на эти
