...
GOLDEN = {'prompts': {'age': {'full': 'Напиши свой возраст числом:',
             ...
             'resume_link': {
                 'full': 'Пришлите ссылку на резюме, портфолио или профиль — например hh.ru, '
                         'GitHub, LinkedIn',
                 'short': 'Пришлите ссылку на резюме, портфолио или профиль — например hh.ru, '
                          'GitHub, LinkedIn',
                 'party_overnight': 'Пришлите ссылку на резюме, портфолио или профиль — '
                                    'например hh.ru, GitHub, LinkedIn'},
             'mini_projects': {
                 'full': 'Расскажите о своих проектах — учебных, пет-, рабочих. Что делали, '
                         'какую роль играли?',
                 'short': 'Расскажите о своих проектах — учебных, пет-, рабочих. Что делали, '
                          'какую роль играли?',
                 'party_overnight': 'Расскажите о своих проектах — учебных, пет-, рабочих. Что '
                                    'делали, какую роль играли?'},
             'mini_portfolio': {
                 ...
                 'party_overnight': 'Есть ссылка на портфолио, GitHub или соцсети с работами? '
                                    'Можно пропустить.'},
             'mini_direction': {'full': 'В каком направлении хотите развиваться?',
                                'short': 'В каком направлении хотите развиваться?',
                                'party_overnight': 'В каком направлении хотите развиваться?'},
             'case_optin': {
                 'full': 'Кейс-чемпионат — это возможность решить бизнес-кейс от партнёров и '
                         'получить обратную связь. Участвуете?',
                 ...
                 'party_overnight': 'Кейс-чемпионат — это возможность решить бизнес-кейс от '
                                    'партнёров и получить обратную связь. Участвуете?'},
