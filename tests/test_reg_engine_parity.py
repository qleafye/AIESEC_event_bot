...
GOLDEN = {'prompts': {'age': {'full': 'Напиши свой возраст числом:',
             ...
             # Phase 28 (28-01, СкиллАп 5) — восемь НОВЫХ шагов, снимок расширен ТОЛЬКО
             # добавлением (Pitfall 2 RESEARCH); существующие записи выше не тронуты.
             'stack': {'full': 'Что из этого пробовал(а)? Можно выбрать несколько.',
                       'short': 'Что из этого пробовал(а)? Можно выбрать несколько.',
                       'party_overnight': 'Что из этого пробовал(а)? Можно выбрать несколько.'},
             'experience': {'full': 'Какой у тебя опыт работы?',
                            'short': 'Какой у тебя опыт работы?',
                            'party_overnight': 'Какой у тебя опыт работы?'},
             'readiness': {'full': 'Когда готов(а) выйти на работу?',
                           'short': 'Когда готов(а) выйти на работу?',
                           'party_overnight': 'Когда готов(а) выйти на работу?'},
             ...
             'resume': {'full': 'Прикрепи резюме файлом (PDF или DOCX) или напиши его текстом.',
                        ...
                        'party_overnight': 'Прикрепи резюме файлом (PDF или DOCX) или напиши его '
                                           'текстом.'},
             # Phase 28 (28-01, СкиллАп 5) — развилка резюме R2b/R2c, снимок расширен добавлением.
             # Follow-up 28-10 (fix «вы»->«ты»): пять строк ниже переписаны на «ты» — бот
             # везде на «ты», дефолты 28-01 были ошибочно на «вы».
             'resume_link': {
                 'full': 'Пришли ссылку на резюме, портфолио или профиль — например hh.ru, '
                         'GitHub, LinkedIn',
                 'short': 'Пришли ссылку на резюме, портфолио или профиль — например hh.ru, '
                          'GitHub, LinkedIn',
                 'party_overnight': 'Пришли ссылку на резюме, портфолио или профиль — '
                                    'например hh.ru, GitHub, LinkedIn'},
             'mini_projects': {
                 'full': 'Расскажи о своих проектах — учебных, пет-, рабочих. Что делал(а), '
                         'какую роль играл(а)?',
                 'short': 'Расскажи о своих проектах — учебных, пет-, рабочих. Что делал(а), '
                          'какую роль играл(а)?',
                 'party_overnight': 'Расскажи о своих проектах — учебных, пет-, рабочих. Что '
                                    'делал(а), какую роль играл(а)?'},
             'mini_portfolio': {
                 'full': 'Есть ссылка на портфолио, GitHub или соцсети с работами? Можно '
                         'пропустить.',
                 'short': 'Есть ссылка на портфолио, GitHub или соцсети с работами? Можно '
                          'пропустить.',
                 'party_overnight': 'Есть ссылка на портфолио, GitHub или соцсети с работами? '
                                    'Можно пропустить.'},
             'mini_direction': {'full': 'В каком направлении хочешь развиваться?',
                                'short': 'В каком направлении хочешь развиваться?',
                                'party_overnight': 'В каком направлении хочешь развиваться?'},
             'case_optin': {
                 'full': 'Кейс-чемпионат — это возможность решить бизнес-кейс от партнёров и '
                         'получить обратную связь. Участвуешь?',
                 'short': 'Кейс-чемпионат — это возможность решить бизнес-кейс от партнёров и '
                          'получить обратную связь. Участвуешь?',
                 'party_overnight': 'Кейс-чемпионат — это возможность решить бизнес-кейс от '
                                    'партнёров и получить обратную связь. Участвуешь?'},
