...
KNOWN_OVERAGES: dict[str, tuple[int, str]] = {
    ...
    "admin_caps.py": (
        1025,
        "План 31-11 (D-18/D-19): +3 строки — capability-записи журнала «🤖 Автоотказы» "
        "(admin_reject_journal/arj_*, moderate_reg — та же капа, что вся модерация заявок, "
        "хотя вход виден с экрана правил под settings); 1015 -> 1018, потолок с запасом на "
        "чип «только помеченные правилами» (appr_flag:*) той же волны. "
