...
KNOWN_OVERAGES: dict[str, tuple[int, str]] = {
    ...
    "admin_settings.py": (
        2244,
        "+23 строки (ревью фазы 20) -- изоляция данных потоков EditSetting (вход задаёт данные "
        ...
        "прочитанной шапки города в settings_toggle_rows (WR-05: экран раздела рисует шапку и "
        "тумблеры одной клавиатурой, два независимых чтения давали разъезд города). "
