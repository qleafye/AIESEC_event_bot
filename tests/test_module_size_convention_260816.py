...
KNOWN_OVERAGES: dict[str, tuple[int, str]] = {
    ...
    "admin_settings.py": (
        2167,
        "+61 строка (Phase 20, 20-04: экраны возврата после действия) -- обратный индекс "
        "_group_of_setting_key (ключ настройки -> её группа, выведен из SETTINGS_GROUPS), "
        "константа PHOTO_FILE_GROUP и ленивые швы на handlers/admin_sections.py в кнопках "
        "возврата; сам резолвер экрана возврата (settings_return_screen) живёт в "
        "admin_sections.py, сюда не добавлен. "
