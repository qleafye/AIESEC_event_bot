...
KNOWN_OVERAGES: dict[str, tuple[int, str]] = {
    ...
    "admin_settings.py": (
        2101,
        "+39 строк (Phase 20, разделы по flow делегата) -- вынос текстов тумблеров лендинга "
        "в settings_toggle_rows (единственный источник кнопок и для старого экрана, и для "
        "экранов разделов: одна подпись тумблера в двух местах = два разных текста) и "
        "разрез «📝 Регистрация» на анкету + новую группу «📋 Заявки» (_APPS_FIELD_ORDER); "
        "сами экраны разделов живут в новом модуле handlers/admin_sections.py, сюда не "
        "добавлены. "
